      ...
      <div class="modal-body">
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <input type="number" name="examQuestDipLimit" id="" class="form-control" placeholder="Input Number of Questions">
          </div>
        ...
        <div class="col-md-12">
          ...
          <fieldset>
            ...
            <div class="form-group" style="">
                ...
                <input type="" name="choice_A" id="choice_A" class="form-control" placeholder="Input Max Marks" autocomplete="off">
            </div>

            <div class="form-group" style="">
                <label>Criteria</label>
                <input type="" name="choice_D" id="choice_D" class="form-control" placeholder="Input Criteria" autocomplete="off">
            </div>
