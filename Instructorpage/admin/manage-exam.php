                                               ...
                                               while ($selQuestionRow = $selQuest->fetch(PDO::FETCH_ASSOC)) { ?>
                                                <tr>
                                                        <td >
                                                            ...
                                                            <span class="pl-4 text-success"><?php echo  $selQuestionRow['exam_answer']; ?></span><br>
                                                            <span class="pl-4"><?php ?> Mark: <?php echo  $selQuestionRow['exam_ch1']; ?></span>
                                                         
                                                            <span class="pl-4"><?php ?> Criteria: <?php echo  $selQuestionRow['exam_ch4']; ?></span>
